...
<body class="main">
    ...
    <div class="form">  
        ...
        <div class="main">
            ...
            <button id="e" class="btn" type="submit" name="a">submit</button>
            </form>
        </div>
        <div class="button-sing">
            <a class="button" href="sabtnam.php"> sing up</a>
            <a style="margin-left: 50px;" class="button" href="singin.php">sing in</a>
        </div>
    </div>
</body>
...
if (isset($_POST["a"])) {
    try {
            ...
            $x = htmlentities($_POST['username']);
            $hashedPassword = htmlentities($_POST['password']);
